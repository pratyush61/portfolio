        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Hello! I'm Pratyush Dubey, a frontend web developer with a
            ...
            <p className="text-muted-foreground">
              ...
              JavaScript, and Tailwind CSS. My goal is to craft visually
              appealing interfaces that provide real value to users and
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Optimizing web performance to ensure fast load times and
                    smooth interactions.
                  </p>
                </div>
              </div>
